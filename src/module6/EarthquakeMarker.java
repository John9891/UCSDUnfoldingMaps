...
//When implemented Comparable interface, it generated error because subclasses that inherited from this class
//has to implement method too
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// TODO: Add the method:
	public int compareTo(EarthquakeMarker mark){
		
		
		Float thisMag = new Float(this.getMagnitude());
		Float markMag = new Float(mark.getMagnitude());
		return (thisMag.compareTo(markMag));
	}
